...
export default function Header() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 flex h-16 items-center justify-between px-4 transition-colors duration-300 md:px-8 ${
        scrolled ? "bg-black/60 backdrop-blur-md" : "bg-transparent"
      }`}
    >
      {/* Left: Logo */}
      <Link href="/" className="flex shrink-0 items-center gap-2" aria-label="即梦AI创作指南首页">
        <svg
          width="32"
          height="32"
          viewBox="0 0 32 32"
